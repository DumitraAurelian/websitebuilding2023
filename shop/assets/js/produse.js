...
async function getProducts() {
    ...
    // await inseamna ca asteapta iar apoi il transforma in Json
...
function onLoad() {
    ...
    getProducts().then(function (products) {
        ...
        listProducts(products).then(function (){
            ...
            $container.isotope({
                filter: '.mascara',
                // filtru acesta defineste ce se va deschide la inceput. Daca schimbam filtrul, trebuie sa modificam si HTML ul
                layoutMode: 'masonry',
                animationOptions: {
                    duration: 750,
                    easing: 'linear'
...
async function listProducts(products) {
    ...
    products.forEach(function (product) {
       ...
       `;
    //    target='_blank' inseamna ca deschide o pagina noua
    html +=divProduct;
    });
